...
- [ql-grep](https://github.com/travitch/ql-grep) [4 :star:]: A code search tool that implements CodeQL on the tree-sitter infrastructure
- [build-bom](https://github.com/travitch/build-bom) [48 :star:]: Dynamically discover the commands used to create a piece of software
- [whole-program-llvm](https://github.com/travitch/whole-program-llvm) [701 :star:]: A wrapper script to build whole-program LLVM bitcode files; note that I consider this to be obsoleted by `build-bom`, which takes a more robust approach to the same problem
...
- [semmc](https://github.com/GaloisInc/semmc) [36 :star:]: Stratified synthesis for learning machine code instruction semantics
- [macaw](https://github.com/GaloisInc/macaw) [211 :star:]: Open source binary analysis tools.
...
- [datalog](https://github.com/travitch/datalog) [104 :star:]: A pure Haskell implementation of Datalog
...
- [taffybar](https://github.com/taffybar/taffybar) [701 :star: [:book:](https://hackage.haskell.org/package/taffybar)]: A gtk based status bar for tiling window managers such as XMonad; now maintained by Ivan Malison
