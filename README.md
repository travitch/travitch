...
- [whole-program-llvm](https://github.com/travitch/whole-program-llvm) [584 :star:]: A wrapper script to build whole-program LLVM bitcode files; note that I consider this to be obsoleted by `build-bom`, which takes a more robust approach to the same problem
...
- [datalog](https://github.com/travitch/datalog) [99 :star:]: A pure Haskell implementation of Datalog
...
- [taffybar](https://github.com/taffybar/taffybar) [658 :star: [:book:](https://hackage.haskell.org/package/taffybar)]: A gtk based status bar for tiling window managers such as XMonad; now maintained by Ivan Malison
