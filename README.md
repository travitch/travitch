...
- [whole-program-llvm](https://github.com/travitch/whole-program-llvm) [696 :star:]: A wrapper script to build whole-program LLVM bitcode files; note that I consider this to be obsoleted by `build-bom`, which takes a more robust approach to the same problem
...
- [macaw](https://github.com/GaloisInc/macaw) [208 :star:]: Open source binary analysis tools.
...
- [datalog](https://github.com/travitch/datalog) [102 :star:]: A pure Haskell implementation of Datalog
...
- [taffybar](https://github.com/taffybar/taffybar) [697 :star: [:book:](https://hackage.haskell.org/package/taffybar)]: A gtk based status bar for tiling window managers such as XMonad; now maintained by Ivan Malison
