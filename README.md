...
- [whole-program-llvm](https://github.com/travitch/whole-program-llvm) [713 :star:]: A wrapper script to build whole-program LLVM bitcode files; note that I consider this to be obsoleted by `build-bom`, which takes a more robust approach to the same problem
...
- [macaw](https://github.com/GaloisInc/macaw) [226 :star:]: Open source binary analysis tools.
...
- [taffybar](https://github.com/taffybar/taffybar) [706 :star: [:book:](https://hackage.haskell.org/package/taffybar)]: A gtk based status bar for tiling window managers such as XMonad; now maintained by Ivan Malison
