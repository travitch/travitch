...
- [whole-program-llvm](https://github.com/travitch/whole-program-llvm) [609 :star:]: A wrapper script to build whole-program LLVM bitcode files; note that I consider this to be obsoleted by `build-bom`, which takes a more robust approach to the same problem
...
- [renovate](https://github.com/GaloisInc/renovate) [42 :star:]: A library for binary analysis and rewriting
...
- [taffybar](https://github.com/taffybar/taffybar) [672 :star: [:book:](https://hackage.haskell.org/package/taffybar)]: A gtk based status bar for tiling window managers such as XMonad; now maintained by Ivan Malison
