...
- [ql-grep](https://github.com/travitch/ql-grep) [14 :star:]: A code search tool that implements CodeQL on the tree-sitter infrastructure
...
- [whole-program-llvm](https://github.com/travitch/whole-program-llvm) [734 :star:]: A wrapper script to build whole-program LLVM bitcode files; note that I consider this to be obsoleted by `build-bom`, which takes a more robust approach to the same problem
...
- [semmc](https://github.com/GaloisInc/semmc) [40 :star:]: Stratified synthesis for learning machine code instruction semantics
- [macaw](https://github.com/GaloisInc/macaw) [257 :star:]: Open source binary analysis tools.
...
- [pipemacs](https://github.com/travitch/pipemacs) [1 :star:]: Pipe data from standard input to emacs

## Others

- [taffybar](https://github.com/taffybar/taffybar) [713 :star: [:book:](https://hackage.haskell.org/package/taffybar)]: A gtk based status bar for tiling window managers such as XMonad; now maintained by Ivan Malison
